...
public:
    ...
    void clicked() LE_PATCH( noexcept ) override
    {
...
void MidiKeyboardComponent::mouseMove (const MouseEvent& e) LE_PATCH( noexcept )
{
    updateNoteUnderMouse (e, false);
    shouldCheckMousePos = false;
}

void MidiKeyboardComponent::mouseDrag (const MouseEvent& e) LE_PATCH( noexcept )
{
    float mousePositionVelocity;
...
void MidiKeyboardComponent::mouseEnter (const MouseEvent& e) LE_PATCH( noexcept )
{
    updateNoteUnderMouse (e, false);
}

void MidiKeyboardComponent::mouseExit (const MouseEvent& e) LE_PATCH( noexcept )
{
    updateNoteUnderMouse (e, false);
}

void MidiKeyboardComponent::mouseWheelMove (const MouseEvent&, const MouseWheelDetails& wheel) LE_PATCH( noexcept )
{
...
bool MidiKeyboardComponent::keyStateChanged (const bool /*isKeyDown*/) LE_PATCH( noexcept )
{
