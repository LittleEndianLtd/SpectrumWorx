...
public:
    ...
    */
    void flush() LE_PATCH( noexcept );

    bool write (const void*, size_t) LE_PATCH( noexcept ) override;
    int64 getPosition() LE_PATCH( noexcept ) override                                 { return position; }
    bool setPosition (int64) LE_PATCH( noexcept ) override;
    int writeFromInputStream (InputStream&, int64 maxNumBytesToWrite) override;
    bool writeRepeatedByte (uint8 byte, size_t numTimesToRepeat) LE_PATCH( noexcept ) override;
