...
public:
    ...
    */
    JUCE_ORIGINAL( virtual ) char readByte();
    ...
    */
    JUCE_ORIGINAL( virtual ) bool readBool();
    ...
    */
    JUCE_ORIGINAL( virtual ) short readShort();
    ...
    */
    JUCE_ORIGINAL( virtual ) short readShortBigEndian();
    ...
    */
    JUCE_ORIGINAL( virtual ) int readInt();
    ...
    */
    JUCE_ORIGINAL( virtual ) int readIntBigEndian();
    ...
    */
    JUCE_ORIGINAL( virtual ) int64 readInt64();
    ...
    */
    JUCE_ORIGINAL( virtual ) int64 readInt64BigEndian();
    ...
    */
    JUCE_ORIGINAL( virtual ) float readFloat();
    ...
    */
    JUCE_ORIGINAL( virtual ) float readFloatBigEndian();
    ...
    */
    JUCE_ORIGINAL( virtual ) double readDouble();
    ...
    */
    JUCE_ORIGINAL( virtual ) double readDoubleBigEndian();
    ...
    */
    JUCE_ORIGINAL( virtual ) int readCompressedInt();
    ...
    /** Reads a UTF-8 string from the stream, up to the next linefeed or carriage return.
        ...
        is returned.
    */
    JUCE_ORIGINAL( virtual ) String readNextLine();
    ...
    */
    JUCE_ORIGINAL( virtual ) String readEntireStreamAsString();
    ...
    */
    JUCE_ORIGINAL( virtual ) int readIntoMemoryBlock (MemoryBlock& destBlock,
    ...
    */
    ...
    /** Reads and discards a number of bytes from the stream.
        ...
        have been done.
    */
    JUCE_ORIGINAL( virtual ) void skipNextBytes (int64 numBytesToSkip);
