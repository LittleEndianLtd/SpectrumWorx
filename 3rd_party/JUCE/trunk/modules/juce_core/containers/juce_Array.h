...
public:
    ...
    */
    ElementType remove (const int indexToRemove) LE_PATCH( noexcept )
    {
        const ScopedLockType lock (getLock());
    ...
    */
    void removeFirstMatchingValue (ParameterType valueToRemove) LE_PATCH( noexcept )
    {
        const ScopedLockType lock (getLock());
...
private:
    ...
    void removeInternal (const int indexToRemove) LE_PATCH( noexcept )
    {
        --numUsed;
    ...
    void minimiseStorageAfterRemoval() LE_PATCH( noexcept )
    {
