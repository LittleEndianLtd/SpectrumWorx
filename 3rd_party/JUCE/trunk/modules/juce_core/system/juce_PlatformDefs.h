...
#if JUCE_MSVC || defined( __i386__ )
 #define JUCE_CALLTYPE   __fastcall
...
// Debugging and assertion macros
  ...
  #define juce_LogCurrentAssertion    std::puts( "JUCE Assertion failure in " __FILE__ ", line " __TOSTRING( __LINE__ ) );
#else
...
//==============================================================================
  ...
  */
  ...
  #define juce_breakDebugger        { __debugbreak(); }
     ...
     #define juce_breakDebugger      { Debugger(); raise( SIGTRAP ); }
...
//==============================================================================
...
#if defined( LE_PATCHED_JUCE ) && defined( _MSC_VER ) && 0
  ...
  */
  ...
  #define DBG(dbgtext)
  #define jassertfalse              { juce_LogCurrentAssertion LE_PATCH_ASSUME_IMPL( false ); }

  #if JUCE_LOG_ASSERTIONS
   #define jassert(expression)      { if (! (expression)) jassertfalse; }
  #else
   #ifdef _MSC_VER // MSVC will not force evaluation of a (which may include function calls)
    #define jassert(a)               { LE_PATCH_ASSUME_IMPL( a ); }
   #else
    #define jassert(a)               {}
  #endif // _MSC_VER
  #endif
...
// Declare some fake versions of nullptr and noexcept, for older compilers:
  ...
  #undef noexcept
    ...
    #else
        #pragma message( "no efficient nothrow" )
        #define noexcept
    #endif
#else // LE_PATCHED_JUCE
 #define noexcept  throw()
...
#ifdef LE_PATCHED_JUCE
#ifdef __GNUC__
    //...mrmlj...clang complains "GCC does not allow nothrow attribute in this position on a function definition"
