...
int64 FileOutputStream::getPosition() LE_PATCH( noexcept )
{
    return currentPosition;
}

bool FileOutputStream::setPosition (int64 newPosition) LE_PATCH( noexcept )
{
...
void FileOutputStream::flush() LE_PATCH( noexcept )
{
    flushBuffer();
    flushInternal();
}

bool FileOutputStream::write (const void* const src, const size_t numBytes) LE_PATCH( noexcept )
{
...
bool FileOutputStream::writeRepeatedByte (uint8 byte, size_t numBytes) LE_PATCH( noexcept )
{
