...
*/
class JUCE_API LE_PATCH_NOVTABLE ReferenceCountedObject
{
public:
    //==============================================================================
...
protected:
    ...
    ReferenceCountedObject() LE_PATCH( noexcept )
    {
    }

    /** Destructor. */
    virtual ~ReferenceCountedObject() LE_PATCH( noexcept )
    {
...
*/
class JUCE_API LE_PATCH_NOVTABLE SingleThreadedReferenceCountedObject
{
public:
    //==============================================================================
    /** Increments the object's reference count.
...
protected:
    ...
    /** Destructor. */
    virtual ~SingleThreadedReferenceCountedObject() LE_PATCH( noexcept )
    {
        // it's dangerous to delete an object that's still referenced by something else!
        jassert (getReferenceCount() == 0);
    }
