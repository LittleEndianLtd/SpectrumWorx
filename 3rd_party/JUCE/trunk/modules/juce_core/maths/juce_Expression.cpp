...
public:
    Term() {}
    virtual ~Term() LE_PATCH( noexcept ) {}
...
struct Expression::Helpers
{
    ...
    class EvaluationError JUCE_ORIGINAL( : public std::exception )
    {
    public:
...
{
    LE_PATCH( jassert( false ); )
    JUCE_ORIGINAL( throw Helpers::EvaluationError ("Unknown symbol: " + scopeName); )
}
