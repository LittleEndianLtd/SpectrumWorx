...
public:
    ...
    size_t length() const noexcept
    {
        ...
        return /*std*/::_mbslen( reinterpret_cast<unsigned char const *>( data ) );
    #else
    ...
    {
    #if defined( LE_PATCHED_JUCE ) && defined( _MSC_VER ) && 0
        return /*std*/::_mbsnlen( reinterpret_cast<unsigned char const *>( data ), maxCharsToCount );
    #else
...
#if defined( LE_PATCHED_JUCE ) && defined( _WIN32 )
    int getIntValue32() const noexcept      { return CharacterFunctions::getIntValue<int>( *this ); }
#else
