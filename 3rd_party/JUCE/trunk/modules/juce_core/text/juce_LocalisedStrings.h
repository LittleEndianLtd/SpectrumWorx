...
#define TRANS(stringLiteral) String( stringLiteral )
#else
#ifndef TRANS
...
#ifdef LE_PATCHED_JUCE
inline String && translate ( String && text ) { return static_cast<String &&>( text ); }
template <typename T>
inline String && translate ( T && text, String && resultIfNotFound ) { return static_cast<String &&>( resultIfNotFound ); }
#else
/** Uses the LocalisedStrings class to translate the given string literal.
