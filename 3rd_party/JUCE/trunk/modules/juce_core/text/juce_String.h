...
public:
    ...
    */
    ...
    /** Appends a character at the end of this string. */
    JUCE_ORIGINAL( String& operator+= (juce_wchar characterToAppend); )
   #endif
    ...
    */
    inline bool isEmpty() const noexcept                    { return JUCE_ORIGINAL( text[0] == 0; ) LE_PATCH( text.isEmpty(); ) }

    /** Returns true if the string contains at least one character.
        Note that there's also an isEmpty() method to help write readable code.
        @see containsNonWhitespaceChars()
    */
    inline bool isNotEmpty() const noexcept                 { return JUCE_ORIGINAL( text[0] != 0; ) LE_PATCH( !isEmpty(); ) }
    ...
    */
    ...
    LE_PATCH( bool containsAnyOf (char const * charactersItMightContain) const noexcept );
...
*/
#if !defined( LE_PATCHED_JUCE ) || !defined( NDEBUG ) || defined( __APPLE__ )
