...
void LE_PATCH( JUCE_CALLTYPE ) Logger::outputDebugString (const String& text)
{
...
SystemStats::OperatingSystemType SystemStats::getOperatingSystemType()
{
    ...
    for (LE_PATCH( unsigned ) int i = 0; i < numElementsInArray (types); ++i)
...
LE_PATCH( LE_WEAK_SYMBOL_CONST ) JUCE_ORIGINAL( static ) HiResCounterHandler hiResCounterHandler;
