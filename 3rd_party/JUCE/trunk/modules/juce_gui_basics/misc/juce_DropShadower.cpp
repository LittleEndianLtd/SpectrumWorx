...
void DropShadower::componentMovedOrResized (Component& c, bool /*wasMoved*/, bool /*wasResized*/) LE_PATCH( noexcept )
{
    if (owner == &c)
        updateShadows();
}

void DropShadower::componentBroughtToFront (Component& c) LE_PATCH( noexcept )
{
    if (owner == &c)
        updateShadows();
}

void DropShadower::componentChildrenChanged (Component&) LE_PATCH( noexcept )
{
    updateShadows();
}

void DropShadower::componentParentHierarchyChanged (Component& c) LE_PATCH( noexcept )
{
    if (owner == &c)
    {
        updateParent();
...
void DropShadower::componentVisibilityChanged (Component& c) LE_PATCH( noexcept )
{
    if (owner == &c)
        updateShadows();
}
