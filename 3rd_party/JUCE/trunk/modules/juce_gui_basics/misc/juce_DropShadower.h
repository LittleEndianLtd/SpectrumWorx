...
private:
    ...
    void componentMovedOrResized (Component&, bool, bool) LE_PATCH( noexcept ) override;
    void componentBroughtToFront (Component&) LE_PATCH( noexcept ) override;
    void componentChildrenChanged (Component&) LE_PATCH( noexcept ) override;
    void componentParentHierarchyChanged (Component&) LE_PATCH( noexcept ) override;
