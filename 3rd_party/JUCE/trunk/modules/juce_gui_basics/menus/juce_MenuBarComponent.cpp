...
//==============================================================================
void MenuBarComponent::mouseEnter (const MouseEvent& e) LE_PATCH( noexcept )
{
    if (e.eventComponent == this)
        updateItemUnderMouse (e.getPosition());
}

void MenuBarComponent::mouseExit (const MouseEvent& e) LE_PATCH( noexcept )
{
    if (e.eventComponent == this)
        updateItemUnderMouse (e.getPosition());
}
...
void MenuBarComponent::mouseMove (const MouseEvent& e) LE_PATCH( noexcept )
{
    const MouseEvent e2 (e.getEventRelativeTo (this));
