...
/**
    ...
    @see ListBox
*/
class JUCE_API LE_PATCH_NOVTABLE ListBoxModel
{
public:
    //==============================================================================
    /** Destructor. */
    LE_PATCH( protected: ) JUCE_ORIGINAL( virtual ) ~ListBoxModel()  {} LE_PATCH( public: )

    //==============================================================================
    /** This has to return the number of items in the list.
        @see ListBox::getNumRows()
    */
    virtual int getNumRows() LE_PATCH( noexcept ) = 0;
    ...
    */
    JUCE_ORIGINAL( virtual ) virtual Component* refreshComponentForRow (int rowNumber, bool isRowSelected,
                                               Component* existingComponentToUpdate);

    /** This can be overridden to react to the user clicking on a row.
        @see listBoxItemDoubleClicked
    */
    virtual void listBoxItemClicked (int row, const MouseEvent& e) LE_PATCH( noexcept );
    ...
    */
    ...
    /** This can be overridden to react to the user clicking on a part of the list where
        ...
        @see listBoxItemClicked
    */
    virtual void backgroundClicked() LE_PATCH( noexcept );
    ...
    */
    ...
    /** Override this to be informed when the delete key is pressed.
        ...
        @param lastRowSelected   the last row that had been selected when they pressed the
                                 ...
                                 very useful
    */
    virtual void deleteKeyPressed (int lastRowSelected) LE_PATCH( noexcept );
    ...
    */
    virtual void listWasScrolled() LE_PATCH( noexcept );
    ...
    */
    JUCE_ORIGINAL( virtual ) var getDragSourceDescription (const SparseSet<int>& currentlySelectedRows);

    /** You can override this to provide tool tips for specific rows.
        @see TooltipClient
    */
    JUCE_ORIGINAL( virtual ) String getTooltipForRow (int row);
};
...
public:
    ...
    */
    ...
    ListBoxModel* getModel() const noexcept                     { LE_PATCH_ASSUME( model ); return model; }
    ...
    */
    JUCE_ORIGINAL( virtual ) Image createSnapshotOfSelectedRows (int& x, int& y);
    ...
    */
    ...
    /** @internal */
    bool keyStateChanged (bool isKeyDown) LE_PATCH( noexcept ) override;
    /** @internal */
    ...
    /** @internal */
    void mouseUp (const MouseEvent&) LE_PATCH( noexcept ) override;
    /** @internal */
