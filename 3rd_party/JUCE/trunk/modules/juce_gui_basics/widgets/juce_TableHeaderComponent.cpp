...
void TableHeaderComponent::mouseMove (const MouseEvent& e) LE_PATCH( noexcept )
{
    updateColumnUnderMouse (e);
}

void TableHeaderComponent::mouseEnter (const MouseEvent& e) LE_PATCH( noexcept )
{
    updateColumnUnderMouse (e);
}

void TableHeaderComponent::mouseExit (const MouseEvent& e) LE_PATCH( noexcept )
{
...
void TableHeaderComponent::mouseDrag (const MouseEvent& e) LE_PATCH( noexcept )
{
