...
void ComboBox::valueChanged (Value&) LE_PATCH( noexcept )
{
...
bool ComboBox::keyStateChanged (const bool isKeyDown) LE_PATCH( noexcept )
{
...
void ComboBox::mouseWheelMove (const MouseEvent& e, const MouseWheelDetails& wheel) LE_PATCH( noexcept )
{
   #if 0
