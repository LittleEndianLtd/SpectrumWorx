...
void Label::valueChanged (Value&) LE_PATCH( noexcept )
{
...
void Label::componentMovedOrResized (Component& component, bool /*wasMoved*/, bool /*wasResized*/) LE_PATCH( noexcept )
{
...
void Label::componentVisibilityChanged (Component& component) LE_PATCH( noexcept )
{
