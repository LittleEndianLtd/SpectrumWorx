...
public:
    ...
    void mouseMove (const MouseEvent& e) LE_PATCH( noexcept ) override    { updateButtonUnderMouse (e); }
    void mouseExit (const MouseEvent& e) LE_PATCH( noexcept ) override    { updateButtonUnderMouse (e); }
