...
//==============================================================================
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier MarkerList::ValueTreeWrapper::markerTag ("Marker");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier MarkerList::ValueTreeWrapper::nameProperty ("name");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier MarkerList::ValueTreeWrapper::posProperty ("position");
