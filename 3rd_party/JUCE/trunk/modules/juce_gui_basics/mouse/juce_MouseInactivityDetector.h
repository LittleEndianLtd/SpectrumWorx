...
private:
    ...
    void mouseMove  (const MouseEvent& e) LE_PATCH( noexcept ) override   { wakeUp (e, false); }
    void mouseEnter (const MouseEvent& e) override   { wakeUp (e, false); }
    void mouseExit  (const MouseEvent& e) LE_PATCH( noexcept ) override   { wakeUp (e, false); }
    ...
    void mouseWheelMove (const MouseEvent& e, const MouseWheelDetails&) LE_PATCH( noexcept ) override  { wakeUp (e, true); }
