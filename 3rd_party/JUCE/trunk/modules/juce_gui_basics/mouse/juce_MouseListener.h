...
*/
class JUCE_API LE_PATCH_NOVTABLE MouseListener
{
public:
    /** Destructor. */
    virtual ~MouseListener() LE_PATCH( noexcept ) {}
    ...
    */
    virtual void mouseMove (const MouseEvent& event) LE_PATCH( noexcept );
    ...
    */
    virtual void mouseExit (const MouseEvent& event) LE_PATCH( noexcept );
    ...
    */
    virtual void mouseWheelMove (const MouseEvent& event,
                                 const MouseWheelDetails& wheel) LE_PATCH( noexcept );
