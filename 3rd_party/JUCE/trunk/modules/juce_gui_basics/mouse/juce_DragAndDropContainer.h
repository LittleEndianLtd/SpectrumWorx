...
*/
class JUCE_API LE_PATCH_NOVTABLE DragAndDropContainer
{
public:
    //==============================================================================
    ...
    */
    ...
    /** Destructor. */
    JUCE_ORIGINAL( virtual ) LE_PATCH( protected: ) ~DragAndDropContainer() JUCE_ORIGINAL( ; ) LE_PATCH( {} virtual void dummy() {} public: )
    ...
    */
    void startDragging (const var& sourceDescription,
                        ...
                        Image LE_PATCH( const & ) dragImage = Image::null,
    ...
    /** Returns the description of the thing that's currently being dragged.
        ...
        @see startDragging
    */
    var LE_PATCH( const & ) getCurrentDragDescription() const;
...
protected:
    /** Override this if you want to be able to perform an external drag a set of files
        ...
        @see performExternalDragDropOfFiles
    */
    JUCE_ORIGINAL( virtual ) bool shouldDropFilesWhenDraggedExternally (const DragAndDropTarget::SourceDetails& sourceDetails,
