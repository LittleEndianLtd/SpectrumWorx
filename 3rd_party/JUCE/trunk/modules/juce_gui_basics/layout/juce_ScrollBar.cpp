...
void ScrollBar::lookAndFeelChanged() LE_PATCH( noexcept )
{
...
void ScrollBar::mouseDrag (const MouseEvent& e) LE_PATCH( noexcept )
{
...
void ScrollBar::mouseUp (const MouseEvent&) LE_PATCH( noexcept )
{
    isDraggingThumb = false;
    stopTimer();
    repaint();
...
void ScrollBar::mouseWheelMove (const MouseEvent&, const MouseWheelDetails& wheel) LE_PATCH( noexcept )
{
