...
public:
    ...
    */
    ...
    /** @internal */
    void componentMovedOrResized (Component& component, bool wasMoved, bool wasResized) LE_PATCH( noexcept );
    /** @internal */
    void componentBeingDeleted (Component& component) LE_PATCH( noexcept );
    /** @internal */
    void componentVisibilityChanged (Component& component) LE_PATCH( noexcept );
