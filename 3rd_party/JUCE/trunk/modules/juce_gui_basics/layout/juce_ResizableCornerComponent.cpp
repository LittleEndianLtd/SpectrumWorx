...
void ResizableCornerComponent::mouseDown (const MouseEvent&) LE_PATCH( noexcept )
{
...
void ResizableCornerComponent::mouseDrag (const MouseEvent& e) LE_PATCH( noexcept )
{
    if (component == nullptr)
    {
        jassertfalse; // You've deleted the component that this resizer is supposed to be controlling!
...
void ResizableCornerComponent::mouseUp (const MouseEvent&) LE_PATCH( noexcept )
{
    if (constrainer != nullptr)
