...
void ResizableBorderComponent::mouseEnter (const MouseEvent& e) LE_PATCH( noexcept )
{
    updateMouseZone (e);
}

void ResizableBorderComponent::mouseMove (const MouseEvent& e) LE_PATCH( noexcept )
{
    updateMouseZone (e);
}

void ResizableBorderComponent::mouseDown (const MouseEvent& e) LE_PATCH( noexcept )
{
...
void ResizableBorderComponent::mouseDrag (const MouseEvent& e) LE_PATCH( noexcept )
{
    if (component == nullptr)
    {
        jassertfalse; // You've deleted the component that this resizer was supposed to be using!
...
void ResizableBorderComponent::mouseUp (const MouseEvent&) LE_PATCH( noexcept )
{
    if (constrainer != nullptr)
