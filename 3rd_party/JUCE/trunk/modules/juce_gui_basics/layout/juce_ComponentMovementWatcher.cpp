...
void ComponentMovementWatcher::componentMovedOrResized (Component&, bool wasMoved, bool wasResized) LE_PATCH( noexcept )
{
    if (component != nullptr)
    {
        if (wasMoved)
...
void ComponentMovementWatcher::componentBeingDeleted (Component& comp) LE_PATCH( noexcept )
{
...
void ComponentMovementWatcher::componentVisibilityChanged (Component&) LE_PATCH( noexcept )
{
    if (component != nullptr)
    {
