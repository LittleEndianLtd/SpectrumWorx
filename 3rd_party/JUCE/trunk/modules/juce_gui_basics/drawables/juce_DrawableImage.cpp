...
Rectangle<float> DrawableImage::getDrawableBounds() const LE_PATCH( noexcept )
{
...
//==============================================================================
#ifndef LE_PATCHED_JUCE
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableImage::valueTreeType ("Image");

LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableImage::ValueTreeWrapper::opacity ("opacity");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableImage::ValueTreeWrapper::overlay ("overlay");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableImage::ValueTreeWrapper::image ("image");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableImage::ValueTreeWrapper::topLeft ("topLeft");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableImage::ValueTreeWrapper::topRight ("topRight");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableImage::ValueTreeWrapper::bottomLeft ("bottomLeft");
