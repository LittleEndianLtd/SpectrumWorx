...
//==============================================================================
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableRectangle::valueTreeType ("Rectangle");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableRectangle::ValueTreeWrapper::topLeft ("topLeft");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableRectangle::ValueTreeWrapper::topRight ("topRight");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableRectangle::ValueTreeWrapper::bottomLeft ("bottomLeft");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableRectangle::ValueTreeWrapper::cornerSize ("cornerSize");
