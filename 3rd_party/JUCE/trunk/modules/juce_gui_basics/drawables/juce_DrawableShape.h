...
public:
    /** Destructor. */
    ~DrawableShape() LE_PATCH( noexcept );
    ...
    */
    ...
    #ifdef __APPLE__
        bool recalculateCoords (void          *);
    #else
        bool recalculateCoords (std::nullptr_t*);
    #endif // __APPLE__
    #else
    ...
    */
    ...
    /** @internal */
    Rectangle<float> getDrawableBounds() const LE_PATCH( noexcept ) override;
    /** @internal */
