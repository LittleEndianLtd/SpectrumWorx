...
DrawablePath::~DrawablePath() LE_PATCH( noexcept )
{
}
...
//==============================================================================
#ifndef LE_PATCHED_JUCE
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawablePath::valueTreeType ("Path");

LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawablePath::ValueTreeWrapper::nonZeroWinding ("nonZeroWinding");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawablePath::ValueTreeWrapper::point1 ("p1");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawablePath::ValueTreeWrapper::point2 ("p2");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawablePath::ValueTreeWrapper::point3 ("p3");
#endif // LE_PATCHED_JUCE
...
//==============================================================================
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawablePath::ValueTreeWrapper::Element::mode ("mode");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawablePath::ValueTreeWrapper::Element::startSubPathElement ("Move");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawablePath::ValueTreeWrapper::Element::closeSubPathElement ("Close");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawablePath::ValueTreeWrapper::Element::lineToElement ("Line");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawablePath::ValueTreeWrapper::Element::quadraticToElement ("Quad");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawablePath::ValueTreeWrapper::Element::cubicToElement ("Cubic");

LE_PATCH( LE_WEAK_SYMBOL ) const char* DrawablePath::ValueTreeWrapper::Element::cornerMode = "corner";
LE_PATCH( LE_WEAK_SYMBOL ) const char* DrawablePath::ValueTreeWrapper::Element::roundedMode = "round";
LE_PATCH( LE_WEAK_SYMBOL ) const char* DrawablePath::ValueTreeWrapper::Element::symmetricMode = "symm";
