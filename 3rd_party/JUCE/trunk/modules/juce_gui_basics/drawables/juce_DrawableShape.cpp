...
DrawableShape::~DrawableShape() LE_PATCH( noexcept )
{
}
...
public:
    ...
    void applyNewBounds (const Rectangle<int>&) LE_PATCH( noexcept )
    {
                                     ...
                                     ScopedPointer<RelativeCoordinatePositionerBase>& pos)
{
    if (fill != newFill)
    {
        ...
        {
            JUCE_ORIGINAL( fill.recalculateCoords (nullptr); )
        }
...
Rectangle<float> DrawableShape::getDrawableBounds() const LE_PATCH( noexcept )
{
    if (isStrokeVisible())
...
#ifndef LE_PATCHED_JUCE
bool DrawableShape::RelativeFillType::recalculateCoords (LE_PATCH( std::nullptr_t ) JUCE_ORIGINAL( Expression::Scope* ) scope)
{
    if (fill.isGradient())
    {
...
//==============================================================================
#ifndef LE_PATCHED_JUCE
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableShape::FillAndStrokeState::type ("type");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableShape::FillAndStrokeState::colour ("colour");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableShape::FillAndStrokeState::colours ("colours");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableShape::FillAndStrokeState::fill ("Fill");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableShape::FillAndStrokeState::stroke ("Stroke");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableShape::FillAndStrokeState::path ("Path");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableShape::FillAndStrokeState::jointStyle ("jointStyle");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableShape::FillAndStrokeState::capStyle ("capStyle");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableShape::FillAndStrokeState::strokeWidth ("strokeWidth");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableShape::FillAndStrokeState::gradientPoint1 ("point1");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableShape::FillAndStrokeState::gradientPoint2 ("point2");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableShape::FillAndStrokeState::gradientPoint3 ("point3");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableShape::FillAndStrokeState::radial ("radial");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableShape::FillAndStrokeState::imageId ("imageId");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableShape::FillAndStrokeState::imageOpacity ("imageOpacity");
