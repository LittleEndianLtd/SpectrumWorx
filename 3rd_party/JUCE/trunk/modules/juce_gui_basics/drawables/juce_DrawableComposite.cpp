...
//==============================================================================
LE_PATCH( LE_WEAK_SYMBOL ) const char* const DrawableComposite::contentLeftMarkerName = "left";
LE_PATCH( LE_WEAK_SYMBOL ) const char* const DrawableComposite::contentRightMarkerName = "right";
LE_PATCH( LE_WEAK_SYMBOL ) const char* const DrawableComposite::contentTopMarkerName = "top";
LE_PATCH( LE_WEAK_SYMBOL ) const char* const DrawableComposite::contentBottomMarkerName = "bottom";

//==============================================================================
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableComposite::valueTreeType ("Group");

LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableComposite::ValueTreeWrapper::topLeft ("topLeft");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableComposite::ValueTreeWrapper::topRight ("topRight");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableComposite::ValueTreeWrapper::bottomLeft ("bottomLeft");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableComposite::ValueTreeWrapper::childGroupTag ("Drawables");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableComposite::ValueTreeWrapper::markerGroupTagX ("MarkersX");
LE_PATCH( LE_WEAK_SYMBOL ) const Identifier DrawableComposite::ValueTreeWrapper::markerGroupTagY ("MarkersY");
...
ValueTree DrawableComposite::createValueTree (ComponentBuilder::ImageProvider* imageProvider) const
{
    ...
    for (int i = 0; i < getNumChildComponents(); ++i)
    {
        ...
        jassert( dynamic_cast <const Drawable*>( getChildComponent( i ) ) ); // You can't save a mix of Drawables and normal components!
        Drawable const * const d( static_cast<Drawable const *>( getChildComponent( i ) ) );
    #else
