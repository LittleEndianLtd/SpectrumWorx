                                 ...
                                 : (desc + " (" + fileWildcardPatterns + ")"))
{
    ...
    LE_PATCH( (void)directoryWildcardPatterns );
    JUCE_ORIGINAL( parse (directoryWildcardPatterns, directoryWildcards) );
}
...
{
    LE_PATCH(      (void)file; return true;                 )
    JUCE_ORIGINAL( return match (file, directoryWildcards); )
}
