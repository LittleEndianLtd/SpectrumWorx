...
*/
class JUCE_API LE_PATCH_NOVTABLE FocusChangeListener
{
public: LE_PATCH( protected: )
    /** Destructor. */
    JUCE_ORIGINAL( virtual ) ~FocusChangeListener()  {} LE_PATCH( public: )
...
*/
class JUCE_API  Desktop  : JUCE_ORIGINAL( private DeletedAtShutdown /*,*/ )
                           JUCE_ORIGINAL( private Timer /*,*/ )
...
public:
    ...
    */
    ...
    /** Makes the mouse pointer jump to a given location.
        The coordinates are relative to the top-left of the main monitor.
    */
    static void setMousePosition (Point<int> LE_PATCH( const & ) newPosition);
    ...
    */
    Component* findComponentAt (Point<int> LE_PATCH( const & ) screenPosition) const;
...
private:
    ...
    JUCE_ORIGINAL( Point<int> lastFakeMouseMove; )
    void sendMouseMove();
    ...
    JUCE_ORIGINAL( ScopedPointer<Timer> dragRepeater; )
    ...
    void timerCallback() JUCE_ORIGINAL( override );
    void resetTimer();
