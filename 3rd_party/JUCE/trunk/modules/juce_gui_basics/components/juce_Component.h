...
public:
    ...
    */
    virtual ~Component() LE_PATCH( noexcept );
    ...
    */
    ...
    /** Sets the name of this component.
        ...
        @see getName
    */
    JUCE_ORIGINAL( virtual ) void setName (const String& newName);
    ...
    */
    bool contains (Point<int> LE_PATCH( const & ) localPoint) LE_PATCH( noexcept );
    ...
    */
    bool reallyContains (Point<int> LE_PATCH( const & ) localPoint, bool returnTrueIfWithinAChild) LE_PATCH( noexcept );
    ...
    */
    Component* getComponentAt (int x, int y) LE_PATCH( noexcept );
    ...
    /** Returns the component at a certain point within this one.
        ...
        @see hitTest, contains, reallyContains
    */
    Component* getComponentAt (Point<int> LE_PATCH( const & ) position) LE_PATCH( noexcept );
    ...
    /** Marks the whole component as needing to be redrawn.
        ...
        @see paint
    */
    void repaint() LE_PATCH( noexcept );
    ...
    /** Marks a subsection of this component as needing to be redrawn.
        ...
        @see repaint()
    */
    void repaint (int x, int y, int width, int height) LE_PATCH( noexcept );
    ...
    /** Marks a subsection of this component as needing to be redrawn.
        ...
        @see repaint()
    */
    void repaint (const Rectangle<int>& area) LE_PATCH( noexcept );
    ...
    */
    void setBufferedToImage (bool shouldBeBuffered) LE_PATCH( noexcept );
    ...
    */
    ImageEffectFilter* getComponentEffect() const noexcept              { LE_PATCH_ASSUME( !effect ); return effect; }
    ...
    */
    void setEnabled (bool shouldBeEnabled) LE_PATCH( noexcept );
    ...
    */
    virtual void mouseMove (const MouseEvent& event) LE_PATCH( noexcept ) override;
    ...
    */
    virtual void mouseExit (const MouseEvent& event) LE_PATCH( noexcept ) override;
    ...
    */
    virtual void mouseWheelMove (const MouseEvent& event,
                                 const MouseWheelDetails& wheel) LE_PATCH( noexcept ) override;
    ...
    */
    virtual void mouseMagnify (const MouseEvent& event, float scaleFactor) LE_PATCH( noexcept );
    ...
    */
    void removeMouseListener (MouseListener* listenerToRemove) LE_PATCH( noexcept );
    ...
    */
    ...
    /** Removes a previously-registered key listener.
        @see addKeyListener
    */
    void removeKeyListener (KeyListener* listenerToRemove) LE_PATCH( noexcept );
    ...
    */
    virtual bool keyStateChanged (bool isKeyDown) LE_PATCH( noexcept );
    ...
    */
    virtual void modifierKeysChanged (const ModifierKeys& modifiers) LE_PATCH( noexcept );
    ...
    */
    ...
    public:
        ...
        SafePointer (ComponentType* const component)        : weakRef (component) { /*...mrmlj...required by ModalComponentManager::handleAsyncUpdate under OSX...LE_PATCH( jassert( component ); )*/ }
        ...
        /** Copies another pointer to this one. */
        SafePointer& operator= (ComponentType* const newComponent)  { /*LE_PATCH( jassert( newComponent ); )*/ weakRef = newComponent; return *this; }

        /** Returns the component that this pointer refers to, or null if the component no longer exists. */
    #ifdef LE_PATCHED_JUCE
        #ifndef NDEBUG2 //...mrmlj...popupmenu still requires this...
            ComponentType* getComponent() const noexcept        { /*jassert( weakRef.get() );*/ return static_cast<ComponentType *>( weakRef.get() ); }
        #else
            ComponentType* getComponent() const noexcept        { jassert( weakRef ); return static_cast<ComponentType *>( weakRef ); }
        #endif
    #else
    ...
    private:
    #if defined( LE_PATCHED_JUCE ) || 1 //...mrmlj...popupmenu still requires this...!defined( LE_PATCHED_JUCE ) || !defined( NDEBUG )
    ...
    */
    ...
    private:
        //...mrmlj...popupmenu still requires this...
    ...
    */
    ...
    public:
        ...
        */
        ...
        virtual void applyNewBounds (const Rectangle<int>& newBounds) LE_PATCH( noexcept ) = 0;
#endif // LE_PATCHED_JUCE
...
private:
    ...
    //==============================================================================
    void internalMouseEnter (MouseInputSource&, Point<int> LE_PATCH( const & ), Time);
    void internalMouseExit  (MouseInputSource&, Point<int> LE_PATCH( const & ), Time);
    void internalMouseDown  (MouseInputSource&, Point<int> LE_PATCH( const & ), Time);
    void internalMouseUp    (MouseInputSource&, Point<int> LE_PATCH( const & ), Time, const ModifierKeys oldModifiers);
    void internalMouseDrag  (MouseInputSource&, Point<int> LE_PATCH( const & ), Time);
    void internalMouseMove  (MouseInputSource&, Point<int> LE_PATCH( const & ), Time);
    void internalMouseWheel (MouseInputSource&, Point<int> LE_PATCH( const & ), Time, const MouseWheelDetails&);
    void internalMagnifyGesture (MouseInputSource&, Point<int> LE_PATCH( const & ), Time, float);
    ...
    void internalRepaint (const Rectangle<int>&) LE_PATCH( noexcept );
    void internalRepaintUnchecked (const Rectangle<int>&, bool) LE_PATCH( noexcept );
