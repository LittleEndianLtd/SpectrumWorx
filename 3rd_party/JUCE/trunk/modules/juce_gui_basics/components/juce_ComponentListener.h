...
*/
class JUCE_API LE_PATCH_NOVTABLE ComponentListener
{
public:
    /** Destructor. */
    LE_PATCH( protected: ) JUCE_ORIGINAL( virtual ) ~ComponentListener()  {} LE_PATCH( public: )
    ...
    */
    virtual void componentMovedOrResized (Component& component,
                                          bool wasMoved,
                                          bool wasResized) LE_PATCH( noexcept );
    ...
    */
    virtual void componentBroughtToFront (Component& component) LE_PATCH( noexcept );
    ...
    */
    virtual void componentVisibilityChanged (Component& component) LE_PATCH( noexcept );
    ...
    */
    virtual void componentChildrenChanged (Component& component) LE_PATCH( noexcept );
    ...
    */
    virtual void componentNameChanged (Component& component) LE_PATCH( noexcept );
    ...
    /** Called when the component is in the process of being deleted.
        ...
        point!
    */
    virtual void componentBeingDeleted (Component& component) LE_PATCH( noexcept );
};
