...
*/
class JUCE_API LE_PATCH_NOVTABLE KeyListener
{
public:
    /** Destructor. */
    LE_PATCH( protected: ) JUCE_ORIGINAL( virtual ) ~KeyListener()  {} LE_PATCH( public: )
    ...
    */
    virtual bool keyStateChanged (bool isKeyDown, Component* originatingComponent) LE_PATCH( noexcept );
};
