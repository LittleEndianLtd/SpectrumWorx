...
*/
class JUCE_API LE_PATCH_NOVTABLE CallbackMessage   : public MessageManager::MessageBase
{
public:
    //==============================================================================
    CallbackMessage() noexcept JUCE_ORIGINAL( ; ) LE_PATCH( {} )

    /** Destructor. */
    JUCE_ORIGINAL( ~CallbackMessage(); )
