...
public:
    ...
    */
    ...
    /** Internal class used as the base class for all message objects.
        ...
        classes instead.
    */
    class JUCE_API LE_PATCH_NOVTABLE MessageBase  : public ReferenceCountedObject
    {
    public:
        MessageBase() noexcept {}
        virtual ~MessageBase() LE_PATCH( noexcept ) {}

        virtual void messageCallback() = 0;
        void post() LE_PATCH( noexcept );
...
private:
    ...
    JUCE_ORIGINAL( ScopedPointer <ActionBroadcaster> broadcaster; )
