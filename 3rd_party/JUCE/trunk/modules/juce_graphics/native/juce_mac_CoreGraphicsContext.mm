...
//==============================================================================
void CoreGraphicsContext::setOrigin (int x, int y) LE_PATCH( noexcept )
{
...
void CoreGraphicsContext::addTransform (const AffineTransform& transform) LE_PATCH( noexcept )
{
...
float CoreGraphicsContext::getPhysicalPixelScaleFactor() LE_PATCH( noexcept )
{
...
bool CoreGraphicsContext::clipToRectangle (const Rectangle<int>& r) LE_PATCH( noexcept )
{
...
void CoreGraphicsContext::excludeClipRectangle (const Rectangle<int>& r) LE_PATCH( noexcept )
{
...
bool CoreGraphicsContext::clipRegionIntersects (const Rectangle<int>& r) LE_PATCH( noexcept )
{
    return getClipBounds().intersects (r);
}

Rectangle<int> CoreGraphicsContext::getClipBounds() const LE_PATCH( noexcept )
{
    if (! lastClipRectIsValid)
    {
...
bool CoreGraphicsContext::isClipEmpty() const LE_PATCH( noexcept )
{
...
void CoreGraphicsContext::restoreState() LE_PATCH( noexcept )
{
    CGContextRestoreGState (context);
...
//==============================================================================
void CoreGraphicsContext::setFill (const FillType& fillType) LE_PATCH( noexcept )
{
...
void CoreGraphicsContext::setOpacity (float newOpacity) LE_PATCH( noexcept )
{
    state->fillType.setOpacity (newOpacity);
    setFill (state->fillType);
}

void CoreGraphicsContext::setInterpolationQuality (Graphics::ResamplingQuality quality) LE_PATCH( noexcept )
{
...
void CoreGraphicsContext::setFont (const Font& newFont) LE_PATCH( noexcept )
{
    if (state->font != newFont)
    {
        ...
        state->font = newFont;
            ...
            OSXTypeface* osxTypeface = static_cast <OSXTypeface*> (state->font.getTypeface());
        #else
...
const Font& CoreGraphicsContext::getFont() LE_PATCH( noexcept )
{
    return state->font;
}
