...
public:
    ...
    float getAscent() const LE_PATCH( noexcept )                 { return ascent; }
    float getDescent() const LE_PATCH( noexcept )                { return 1.0f - ascent; }
    float getHeightToPointsFactor() const LE_PATCH( noexcept )   { return fontHeightToPointsFactor; }
