...
public:
    ...
    */
    Image (const Image& other) LE_PATCH( noexcept );
    ...
    /** Makes this image refer to the same underlying image as another object.
        ...
        unshared internal data, call duplicateIfShared().
    */
    Image& operator= (const Image&) LE_PATCH( noexcept );
    ...
    public:
        ...
        */
        ...
        protected:
            BitmapDataReleaser() {}
        public:
            virtual ~BitmapDataReleaser() LE_PATCH( noexcept ) {}
        };

    #if !defined( LE_PATCHED_JUCE ) || JUCE_OPENGL
...
public:
    ...
    virtual void initialiseBitmapData (Image::BitmapData&, int x, int y, Image::BitmapData::ReadWriteMode) LE_PATCH( noexcept ) = 0;
...
public:
    ImageType();
    virtual ~ImageType() LE_PATCH( noexcept );
    ...
    virtual int getTypeID() const LE_PATCH( noexcept ) = 0;
...
public:
    NativeImageType();
    ~NativeImageType() LE_PATCH( noexcept );
