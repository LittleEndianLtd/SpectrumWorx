...
public:
    ...
    PixelARGB() noexcept {}
    JUCE_ORIGINAL( ~PixelARGB() noexcept {} )
    ...
    */
    ...
    forcedinline void premultiply() noexcept
    {
        ...
        unsigned char const alpha( components.a );
    ...
    forcedinline void unpremultiply() noexcept
    {
        ...
        {
            components.b = (uint8) ((components.b * 0xff) / alpha);
            components.g = (uint8) ((components.g * 0xff) / alpha);
            components.r = (uint8) ((components.r * 0xff) / alpha);
        }
    #else
        const uint32 alpha = components.a;
...
public:
    /** Creates a pixel without defining its colour. */
    PixelRGB() noexcept {}
    JUCE_ORIGINAL( ~PixelRGB() noexcept {} )
...
public:
    /** Creates a pixel without defining its colour. */
    PixelAlpha() noexcept {}
    JUCE_ORIGINAL( ~PixelAlpha() noexcept {} )
