...
//==============================================================================
float CustomTypeface::getAscent() const LE_PATCH( noexcept )                 { return ascent; }
float CustomTypeface::getDescent() const LE_PATCH( noexcept )                { return 1.0f - ascent; }
float CustomTypeface::getHeightToPointsFactor() const LE_PATCH( noexcept )   { return ascent; }
