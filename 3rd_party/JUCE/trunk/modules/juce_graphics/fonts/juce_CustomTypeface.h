...
public:
    ...
    */
    ...
    float getAscent() const LE_PATCH( noexcept ) override;
    float getDescent() const LE_PATCH( noexcept ) override;
    float getHeightToPointsFactor() const LE_PATCH( noexcept ) override;
