...
namespace FontValues
{
    ...
    LE_PATCH( LE_WEAK_SYMBOL ) String fallbackFont;
    LE_PATCH( LE_WEAK_SYMBOL ) String fallbackFontStyle;
}

typedef Typeface::Ptr (*GetTypefaceForFont) (const Font&);
LE_PATCH( LE_WEAK_SYMBOL ) GetTypefaceForFont juce_getTypefaceForFont = nullptr;
...
public:
    ...
    {
        const String LE_PATCH( & ) faceName (font.getTypefaceName());
        const String LE_PATCH( & ) faceStyle (font.getTypefaceStyle());
